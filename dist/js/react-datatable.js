...
var RDT = React.createClass({displayName: 'RDT',
    ...
    render: function () {
        ...
        if (this.state.editor) {
            editor = React.createElement(RDTEditor, {key: "rdt-editor", editor: this.state.editor})
        }
        ...
        return (
            React.createElement("div", {className: "rdt-container", ref: "container"}, 
                ...
                React.createElement("table", {className: tableStyle['table']}, 
                    ...
                    React.createElement("tbody", {onClick: this.clickHandler}, 
                     this.ds.data.map(function (data, idx) {
                        //FIXME: we should do proper key check here
                        return React.createElement(RDTRow, {key: idx, index: idx, data: data, config: config})
                    })
...
module.exports = RDT;
},{"./column.jsx":149,"./datasource":150,"./editor.jsx":151,"./row.jsx":152,"react":148}],2:[function(require,module,exports){
            ...
            React.createElement("thead", null, 
                React.createElement("tr", null, " ", 
                    cols.map(function(col) {
                        return React.createElement("td", null, col.header)
                    })
 ...
 *
 */
var RDTEditor = React.createClass({displayName: 'RDTEditor',
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "rdt-editor", style: displayStyle}, 
                React.createElement("input", {ref: "input", style: inputStyle, value: this.state.value})
            )
            );
        ...
        return (
            React.createElement("tr", {'data-index': this.props.index}, " ", 
                    cols.map(function (col) {
                        ...
                        return React.createElement("td", {'data-property': col.property, key: col.property}, data[col.property])
                    })
